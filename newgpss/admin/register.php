      ...
      <div class="card-body">
        <form method="post">
          <div class="form-group">
			...
			<input class="form-control" required type="text" name="adminname" placeholder="Enter admin name">
          </div>
          <div class="form-group">
          ...
          <div class="form-group">
            ...
            <input class="form-control" required type="password" name="confirmpassword" placeholder="Enter confirm password">
          </div>
          <button type="submit" name="add_admin" class="btn btn-primary btn-block">Register</button>
        </form>

...
$getquery="select * from product where categoryid=2";
$perpage=8;
...
<ul class="pager">
					...
					for($i=1;$i<=$num;$i++){
						if($i==$page){
							echo "<li><a href='T-shirt.php?page={$i}'style='background:#000;color:#fff;'>{$i}</a></li>";
						}else
					
							echo "<li><a href='T-shirt.php?page={$i}'>{$i}</a></li>";
			   }

...
$getquery="select * from product where categoryid=3";
$perpage=8;
...
<ul class="pager">
					...
					for($i=1;$i<=$num;$i++){
						if($i==$page){
							echo "<li><a href='Back-Bag.php?page={$i}'style='background:#000;color:#fff;'>{$i}</a></li>";
						}else
					
							echo "<li><a href='Back-Bag.php?page={$i}'>{$i}</a></li>";
			   }
